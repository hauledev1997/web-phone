...
const EditProduct = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:5000/admin/edit-product/${prodId}`, { headers })
      .then(res => res.json())
      .then(data => {
  ...
  const handleSubmit = e => {
    ...
    const postEditProd = async () => {
      const response = await axios.post(
        `http://localhost:5000/admin/edit-product/${prodId}`,
        editProd,
        { headers }
      );
          ...
          <div className='addProduct-form'>
            ...
            <div className='form-control'>
              ...
              <textarea
                ...
                rows={5}
                onChange={e => handleChange(e)}
                defaultValue={editProd.short_desc}></textarea>
            </div>
            <div className='form-control'>
              ...
              <textarea
                ...
                rows={10}
                onChange={e => handleChange(e)}
                defaultValue={editProd.long_desc}></textarea>
            </div>
            <div className='form-control'>
